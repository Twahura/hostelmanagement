...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { Relation: @visitor.Relation, Visiting_date: @visitor.Visiting_date, Visitor_address: @visitor.Visitor_address, Visitor_name: @visitor.Visitor_name, student_id: @visitor.student_id } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { Relation: @visitor.Relation, Visiting_date: @visitor.Visiting_date, Visitor_address: @visitor.Visitor_address, Visitor_name: @visitor.Visitor_name, student_id: @visitor.student_id } }
